...
## -----------------------------------------------------------
2. Regarding the above variables, could you identify the primary and secondary keys?
...
## -----------------------------------------------------------
2. Regarding the above variables, dates variables? which dates are the key features and should not be NULL 
(if they are NULL, the corresponding rows should be deleted.)

## -----------------------------------------------------------
For more learning see:
https://github.com/Leilayousefi/Analysis_Migration_Automation_SAS_to_R/blob/main/README.md
## -----------------------------------------------------------
